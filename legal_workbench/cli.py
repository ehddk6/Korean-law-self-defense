...
def build_parser() -> argparse.ArgumentParser:
    ...
    eval_run.add_argument("--model", default="gpt-5.5")
    ...
    eval_probe.add_argument("--model", default="gpt-5.5")
    ...
    eval_review.add_argument("--model", default="gpt-5.4")
    ...
    eval_distill.add_argument("--model", default="gpt-5.4")
